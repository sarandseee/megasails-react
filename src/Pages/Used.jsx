          ...
          <Container>
            <Row className='mb-5 justify-content-center'>
              <Col md={9} className='pt-3 pb-md-2 pb-lg-5'>
                <h3 className='text-center lh-sm my-3'>Used Yachts</h3>                
                <h5 className='text-center lh-sm my-3'>Browse our extensive inventory of meticulously maintained used yachts for sale, offering exceptional value and timeless elegance.</h5>
